...
class GridGraphic : public sf::Drawable {
   public:
    ...
    GridGraphic(unsigned int number_rows,
                unsigned int number_columns, float relative_margin,
    ...
    std::optional<sf::Vector2f> getPositionRelativeToWindow(int row_index,
                                                            int column_index);
